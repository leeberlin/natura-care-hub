...
export default function Pflegeberatung() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center">
              <Button 
                size="lg" 
                className="text-lg px-10 py-6 bg-emerald-600 hover:bg-emerald-700 text-white shadow-xl transform hover:scale-105 transition-all duration-300 rounded-2xl font-semibold" 
                asChild
              >
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-500">
              <div className="w-16 h-16 rounded-2xl bg-green-100 flex items-center justify-center mb-6 group-hover:bg-green-200 transition-colors duration-300">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container max-w-5xl mx-auto px-4">
          ...
          <div className="mb-20">
            ...
            <div className="p-8 mb-12 rounded-2xl border-l-4 border-emerald-500 bg-white shadow-lg">
              ...
              <p className="text-xl leading-relaxed font-semibold text-gray-800">
                <span className="text-emerald-600">Wir helfen Ihnen dabei,</span> passende Pflege- und Betreuungsangebote zu finden 
              ...
              {[
                ...
                <div key={index} className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 rounded-2xl bg-emerald-600 flex items-center justify-center font-bold text-lg text-white group-hover:bg-emerald-700 transition-colors duration-300">
                      {item.step}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 group hover:shadow-xl transition-all duration-300">
              <h4 className="flex items-center text-2xl font-bold mb-6 text-gray-800">
                <div className="w-12 h-12 rounded-2xl bg-green-100 flex items-center justify-center mr-4 group-hover:bg-green-200 transition-colors duration-300">
              ...
              <ul className="space-y-3">
                <li className="flex items-center text-gray-700">
                  <div className="w-3 h-3 rounded-full mr-4 bg-green-500"></div>
      ...
      {/* CTA Section */}
      <section className="py-20 text-white bg-emerald-600 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-12">
            <Button 
              size="lg" 
              className="text-lg px-10 py-6 bg-white text-emerald-600 border-2 border-white hover:bg-emerald-50 hover:text-emerald-700 shadow-xl transform hover:scale-105 transition-all duration-300 rounded-2xl font-bold" 
              asChild
            >
              <a href="/digital-beratung" className="inline-flex items-center gap-3">
                <Calendar className="h-6 w-6" />
            ...
            <Button 
              size="lg" 
              className="text-lg px-10 py-6 bg-transparent text-white border-2 border-white hover:bg-green-50 hover:text-emerald-600 shadow-xl transform hover:scale-105 transition-all duration-300 rounded-2xl font-bold" 
              asChild
            >
